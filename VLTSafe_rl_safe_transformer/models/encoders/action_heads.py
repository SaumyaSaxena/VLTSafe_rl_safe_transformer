# Adapted from https://github.com/octo-models/octo
...
class ContinuousActionHead(nn.Module):
    ...
    def forward(self, transformer_outputs: Dict[str, Any], train: bool = True):
        """
        Returns:
    ...
    def loss(
        self,
        transformer_outputs: Dict[str, Any],
        actions,
        pad_mask,
        train: bool = True,
    ):
...
class SquashedGaussianActionHead(nn.Module):
    ...
    def forward(self, transformer_outputs: Dict[str, Any], deterministic: bool = False, with_logprob: bool = True):
        """
        Returns:
            mean: Predicted actions w/ shape (batch_size, window_size, pred_horizon, action_dim)
        """
...
class ValueHead(nn.Module):
    ...
    def forward(self, transformer_outputs: Dict[str, Any], actions_out: torch.Tensor, train: bool = True):
        """
        Returns:
