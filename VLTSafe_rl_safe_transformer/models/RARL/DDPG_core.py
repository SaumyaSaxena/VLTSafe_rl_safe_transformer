...
from VLTSafe_rl_safe_transformer.models.encoders.tokenizers import *
from VLTSafe_rl_safe_transformer.models.encoders.action_heads import *
from VLTSafe_rl_safe_transformer.models.encoders.transformer import Transformer, SinusoidalPositionalEncoding
import einops
        ...
        if tokenizer_kwargs is not None:
            for _, kwargs in tokenizer_kwargs.items():
                if len(kwargs.kwargs.obs_stack_keys) > 0:
                    tokenizers.append(
                        eval(kwargs.name)(
                            input_shape=self.env_observation_shapes[kwargs.kwargs.obs_stack_keys[0]],
